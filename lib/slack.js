	...
	_createClass(LazySource, [{
		...
		value: function skip(n) {
			...
			var lazy = Object.create(this, {
				apply: {
					value: regeneratorRuntime.mark(function value() {
						var total, _iteratorNormalCompletion15, _didIteratorError15, _iteratorError15, _iterator15, _step15, _e11;
							...
							while (1) {
								switch (_context12.prev = _context12.next) {
									case 0:
										...
										_context12.prev = 4;
										_iterator15 = s.apply()[Symbol.iterator]();
								...
								while (1) {
									switch (_context13.prev = _context13.next) {
										case 0:
											...
											_context13.prev = 4;
											_iterator16 = s.apply()[Symbol.iterator]();
								...
								while (1) {
									switch (_context14.prev = _context14.next) {
										case 0:
											...
											_context14.prev = 4;
											_iterator17 = s.apply()[Symbol.iterator]();
		...
		value: function toArray() {
			...
			try {
				for (var _iterator19 = this.apply()[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
		...
		value: regeneratorRuntime.mark(function enumerate() {
			var _iteratorNormalCompletion20, _didIteratorError20, _iteratorError20, _iterator20, _step20, _e16;

			return regeneratorRuntime.wrap(function enumerate$(_context15) {
				while (1) {
					switch (_context15.prev = _context15.next) {
						case 0:
							...
							_context15.prev = 3;
							_iterator20 = this.source.apply()[Symbol.iterator]();
						...
						case 14:
							...
							_iteratorError20 = _context15.t0;
		...
		value: function any(f) {
			...
			try {
				for (var _iterator26 = this.source.apply()[Symbol.iterator](), _step26; !(_iteratorNormalCompletion26 = (_step26 = _iterator26.next()).done); _iteratorNormalCompletion26 = true) {
					var _e22 = _step26.value;

					if (f(_e22)) return true;
				}
			} catch (err) {
		...
		value: function all(f) {
			...
			try {
				for (var _iterator27 = this.source.apply()[Symbol.iterator](), _step27; !(_iteratorNormalCompletion27 = (_step27 = _iterator27.next()).done); _iteratorNormalCompletion27 = true) {
					var _e23 = _step27.value;

					if (!f(_e23)) return false;
				}
			} catch (err) {
		...
		value: function countWhere(f) {
			...
			try {
				for (var _iterator28 = this.source.apply()[Symbol.iterator](), _step28; !(_iteratorNormalCompletion28 = (_step28 = _iterator28.next()).done); _iteratorNormalCompletion28 = true) {
		...
		value: function minimum() {
			...
			try {
				for (var _iterator29 = this.source.apply()[Symbol.iterator](), _step29; !(_iteratorNormalCompletion29 = (_step29 = _iterator29.next()).done); _iteratorNormalCompletion29 = true) {
		...
		value: function maximum() {
			...
			try {
				for (var _iterator30 = this.source.apply()[Symbol.iterator](), _step30; !(_iteratorNormalCompletion30 = (_step30 = _iterator30.next()).done); _iteratorNormalCompletion30 = true) {
		...
		value: function size() {
			...
			try {
				for (var _iterator31 = this.source.apply()[Symbol.iterator](), _step31; !(_iteratorNormalCompletion31 = (_step31 = _iterator31.next()).done); _iteratorNormalCompletion31 = true) {
					var v = _step31.value;
